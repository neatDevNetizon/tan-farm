...
contract TANVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 TANAtLastUserAction; // keeps track of TAN deposited at the last user action
    ...
    /**
     * @notice Constructor
     * @param _token: TAN token contract
    ...
    /**
     * @notice Deposits funds into the TAN Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in TAN)
     */
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        user.TANAtLastUserAction = user.shares.mul(balanceOf()).div(totalShares);
    ...
    /**
     * @notice Reinvests TAN tokens into Craftsman
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the TAN Vault
     */
    ...
    /**
     * @notice Withdraws from funds from the TAN Vault
